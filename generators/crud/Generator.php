...
class Generator extends \yii\gii\Generator
{
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'indexWidgetType' => 'This is the widget type to be used in the index page to display list of the models.
                You may choose either <code>GridView extended</code>, <code>DataTable GridView</code> ,<code>GridView</code> or <code>ListView</code>',
    ...
    public function generateActiveField($attribute)
    {
        ...
        if ($column->phpType === 'boolean') {
            return "\$form->field(\$model, '$attribute')->checkbox(['class'=>'js-switch']) # to active switch style uncomment switchery assets in _form.php";
        }
